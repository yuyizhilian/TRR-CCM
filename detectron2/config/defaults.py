...
#  --------------------------------------defrcn configs start-----------------------------------------
_C.MODEL.META_ARCHITECTURE = "DeFRCN"
...
# ------------- TEST ------------- #
_C.TEST.PCB_ENABLE = False
_C.TEST.PCB_MODELTYPE = 'resnet'             # res-like
_C.TEST.PCB_MODELPATH = ""
...
_C.MODEL.TRAIN_GCN = False
_C.MODEL.GCN_KERNEL_SIZE = 10
_C.MODEL.GCN_RELATION_K = 32

_C.MODEL.DEFORM_WEIGHT = 0.5
