...
def voc_eval(detpath, annopath, imagesetfile, classname, ovthresh=0.5, use_07_metric=False):
    ...
    # if ovthresh == 0.5:
    #     # 漏检
    #     for image_id in class_recs:
    #         miss_det = False
    #         gt_num = len(class_recs[image_id]['bbox'])
    #         if gt_num == 0:
    #             continue
    #         if class_recs[image_id]['det'][0] == False:
    #             miss_det = True
    #         elif class_recs[image_id]['det'][0] < gt_num:
    #             miss_det = True
            
    #         if miss_det:
    #             content = ''
    #             with open('test/mis_detection.txt', 'r') as file:
    #                 content = file.readlines()
    #             if (classname + ',' + image_id  + '\n') not in content:
    #                 content.append(classname + ',' + image_id + '\n')
    ...
    #         if fp[d] == 1.0:
    #             content = ''
    #             with open('test/false_detection.txt', 'r') as file:
    #                 content = file.readlines()
    #             if (classname + ',' + image_ids[d]  + '\n') not in content:
    #                 with open('test/false_detection.txt', 'w') as file:
    #                     content.append(classname + ',' + image_ids[d] + '\n')
    #                     file.writelines(content)
