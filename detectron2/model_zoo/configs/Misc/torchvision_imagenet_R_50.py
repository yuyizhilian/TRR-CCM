"""
An example config file to train a ImageNet classifier with detectron24.
Model and dataloader both come from torchvision.
This shows how to use detectron24 as a general engine for any new models and tasks.
...
proof-of-concept, to easily demonstrate what's needed to train a ImageNet classifier in detectron24.
